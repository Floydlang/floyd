...
void check_variable(const floyd_parser::scope_ref_t& scope_def, const std::string& s){
...
void check_type(const floyd_parser::scope_ref_t& scope_def, const std::string& s){
...
void are_symbols_resolvable(const floyd_parser::scope_ref_t& scope_def, const expression_t& e){
...
void are_symbols_resolvable(const floyd_parser::scope_ref_t& scope_def, const statement_t& statement){
	QUARK_ASSERT(scope_def && scope_def->check_invariant());
...
void are_symbols_resolvable(const floyd_parser::scope_ref_t& scope_def){
	QUARK_ASSERT(scope_def && scope_def->check_invariant());
