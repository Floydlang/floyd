...
static gen_scope_t bcgen_block(bcgenerator_t& gen_acc, const lexical_scope_t& body);
...
static symbol_pos_t add_local_const(const types_t& types, gen_scope_t& body_acc, const value_t& value, const std::string& name){
	QUARK_ASSERT(types.check_invariant());
	QUARK_ASSERT(body_acc.check_invariant());
	QUARK_ASSERT(value.check_invariant());
	QUARK_ASSERT(name.empty() == false);
...
static gen_scope_t flatten_body(const bcgenerator_t& gen, const gen_scope_t& dest, const gen_scope_t& source){
...
//		body_acc._instrs.push_back(bcgen_instruction_t(is_ext ? bc_opcode::k_load_global_external_value : bc_opcode::k_load_global_inplace_value, dest_reg, make_imm_int(source_reg._index), {}));
	...
	//	global <= local
		...
		body_acc._instrs.push_back(gen_instruction_t(is_ext ? bc_opcode::k_store_global_external_value : bc_opcode::k_store_global_inplace_value, make_imm_int(dest_reg._index), source_reg, {}));
	}
	//	local <= global
	else if(dest_reg._parent_steps != symbol_pos_t::k_global_scope && source_reg._parent_steps == symbol_pos_t::k_global_scope){
		body_acc._instrs.push_back(gen_instruction_t(is_ext ? bc_opcode::k_load_global_external_value : bc_opcode::k_load_global_inplace_value, dest_reg, make_imm_int(source_reg._index), {}));
	}
	//	local <= local
	else{
...
static gen_scope_t bcgen_assign2_statement(bcgenerator_t& gen_acc, const statement_t::assign2_t& statement, const gen_scope_t& body){
...
#if 1
static gen_scope_t bcgen_init2_statement(bcgenerator_t& gen_acc, const statement_t::init2_t& statement, const gen_scope_t& body){
	QUARK_ASSERT(gen_acc.check_invariant());
	QUARK_ASSERT(body.check_invariant());
...
static gen_scope_t bcgen_block_statement(bcgenerator_t& gen_acc, const statement_t::block_statement_t& statement, const gen_scope_t& body){
	QUARK_ASSERT(gen_acc.check_invariant());
	QUARK_ASSERT(body.check_invariant());
...
static gen_scope_t bcgen_return_statement(bcgenerator_t& gen_acc, const statement_t::return_statement_t& statement, const gen_scope_t& body){
	QUARK_ASSERT(gen_acc.check_invariant());
	QUARK_ASSERT(body.check_invariant());
...
static gen_scope_t bcgen_ifelse_statement(bcgenerator_t& gen_acc, const statement_t::ifelse_statement_t& statement, const gen_scope_t& body){
	QUARK_ASSERT(gen_acc.check_invariant());
	QUARK_ASSERT(body.check_invariant());
...
static gen_scope_t bcgen_for_statement(bcgenerator_t& gen_acc, const statement_t::for_statement_t& statement, const gen_scope_t& body){
	QUARK_ASSERT(gen_acc.check_invariant());
	QUARK_ASSERT(body.check_invariant());
	...
	//	Skip entire loop?
	body_acc._instrs.push_back(gen_instruction_t(condition_opcode1, end_expr._out, counter_reg, make_imm_int(leave_pc - get_count(body_acc._instrs))));
	...
	body_acc._instrs.push_back(gen_instruction_t(condition_opcode2, counter_reg, end_expr._out, make_imm_int(body_start_pc - get_count(body_acc._instrs))));

	QUARK_ASSERT(body_acc.check_invariant());
	return body_acc;
}

static gen_scope_t bcgen_while_statement(bcgenerator_t& gen_acc, const statement_t::while_statement_t& statement, const gen_scope_t& body){
	QUARK_ASSERT(gen_acc.check_invariant());
	QUARK_ASSERT(body.check_invariant());
	...
	const auto condition_expr = generate_expression(gen_acc, {}, statement._condition, body_acc);
	body_acc = condition_expr._body;
	body_acc._instrs.push_back(gen_instruction_t(bc_opcode::k_branch_false_bool, condition_expr._out, make_imm_int(body_instr_count + 2), {}));
	body_acc = flatten_body(gen_acc, body_acc, loop_body);
	const auto body_end_pc = static_cast<int>(body_acc._instrs.size());
	body_acc._instrs.push_back(gen_instruction_t(bc_opcode::k_branch_always, make_imm_int(condition_pc - body_end_pc), {}, {} ));
	return body_acc;
}

static gen_scope_t bcgen_expression_statement(bcgenerator_t& gen_acc, const statement_t::expression_statement_t& statement, const gen_scope_t& body){
	QUARK_ASSERT(gen_acc.check_invariant());
	QUARK_ASSERT(body.check_invariant());
...
static gen_scope_t bcgen_block_statements(bcgenerator_t& gen_acc, const gen_scope_t& body, const std::vector<statement_t>& statements){
	QUARK_ASSERT(gen_acc.check_invariant());
	QUARK_ASSERT(body.check_invariant());
...
static gen_scope_t bcgen_top_scope(bcgenerator_t& gen_acc, gen_scope_t& body_acc, const lexical_scope_t& body){
	QUARK_ASSERT(gen_acc.check_invariant());
	QUARK_ASSERT(body.check_invariant());
...
static gen_scope_t bcgen_function(bcgenerator_t& gen_acc, const floyd::function_definition_t& function_def){
...
static gen_expr_out_t bcgen_resolve_member_expression(bcgenerator_t& gen_acc, const symbol_pos_t& target_reg, const expression_t& e, const expression_t::resolve_member_t& details, const gen_scope_t& body){
	QUARK_ASSERT(gen_acc.check_invariant());
...
static gen_expr_out_t bcgen_make_fallthrough_intrinsic(bcgenerator_t& gen_acc, const symbol_pos_t& target_reg, const type_t& call_output_type, const expression_t::intrinsic_t& details, const gen_scope_t& body){
	QUARK_ASSERT(gen_acc.check_invariant());
...
static gen_expr_out_t make_update_call(bcgenerator_t& gen_acc, const symbol_pos_t& target_reg, const type_t& output_type, const expression_t& parent, const expression_t& key, const expression_t& new_value, const gen_scope_t& body){
	QUARK_ASSERT(gen_acc.check_invariant());
...
static gen_expr_out_t bcgen_intrinsic_push_back_expression(bcgenerator_t& gen_acc, const symbol_pos_t& target_reg, const type_t& call_output_type, const expression_t::intrinsic_t& details, const gen_scope_t& body){
	QUARK_ASSERT(gen_acc.check_invariant());
	QUARK_ASSERT(target_reg.check_invariant());
	QUARK_ASSERT(call_output_type.check_invariant());
	QUARK_ASSERT(body.check_invariant());
...
static gen_expr_out_t bcgen_intrinsic_size_expression(bcgenerator_t& gen_acc, const symbol_pos_t& target_reg, const type_t& call_output_type, const expression_t::intrinsic_t& details, const gen_scope_t& body){
	QUARK_ASSERT(gen_acc.check_invariant());
	QUARK_ASSERT(target_reg.check_invariant());
	QUARK_ASSERT(call_output_type.check_invariant());
	QUARK_ASSERT(body.check_invariant());
	...
	if(opcode != bc_opcode::k_nop){
		...
		body_acc._instrs.push_back(gen_instruction_t(opcode, target_reg2, arg1_expr._out, make_imm_int(0)));
		QUARK_ASSERT(body_acc.check_invariant());
...
static call_setup_t gen_call_setup(bcgenerator_t& gen_acc, const std::vector<type_t>& function_def_arg_type, const expression_t* args, int callee_arg_count, const gen_scope_t& body){
	QUARK_ASSERT(gen_acc.check_invariant());
...
static gen_expr_out_t generate_call_expression(bcgenerator_t& gen_acc, const symbol_pos_t& target_reg, const type_t& call_output_type, const expression_t::call_t& details, const gen_scope_t& body){
	...
	if(call_setup._stack_count > 0){
		body_acc._instrs.push_back(gen_instruction_t(bc_opcode::k_popn, make_imm_int(call_setup._stack_count), make_imm_int(extbits), {} ));
	}
