...
struct llvm_code_generator_t {
	public: llvm_code_generator_t(llvm_instance_t& i, llvm::Module* module, const types_t& interner, const llvm_type_lookup& type_lookup, const std::vector<function_link_entry_t>& link_map, const compiler_settings_t& settings, const intrinsic_signatures_t& intrinsic_signatures) :
		instance(&i),
		module(module),
		builder(i.context),
