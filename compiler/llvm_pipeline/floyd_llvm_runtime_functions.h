...
struct runtime_functions_t {
	runtime_functions_t(const std::vector<llvm_codegen_function_type_t>& function_defs);


	////////////////////////////////		STATE

	const llvm_codegen_function_type_t floydrt_init;
	const llvm_codegen_function_type_t floydrt_deinit;

	const llvm_codegen_function_type_t floydrt_alloc_kstr;
	const llvm_codegen_function_type_t floydrt_allocate_vector_fill;
	const llvm_codegen_function_type_t floydrt_store_vector_element_hamt_mutable;
	const llvm_codegen_function_type_t floydrt_concatunate_vectors;
	const llvm_codegen_function_type_t floydrt_load_vector_element_hamt;
	
	const llvm_codegen_function_type_t floydrt_allocate_dict;

	const llvm_codegen_function_type_t floydrt_allocate_json;
	const llvm_codegen_function_type_t floydrt_lookup_json;
	const llvm_codegen_function_type_t floydrt_json_to_string;

	const llvm_codegen_function_type_t floydrt_allocate_struct;

	const llvm_codegen_function_type_t floydrt_compare_values;

	const llvm_codegen_function_type_t floydrt_get_profile_time;
	const llvm_codegen_function_type_t floydrt_analyse_benchmark_samples;
};
