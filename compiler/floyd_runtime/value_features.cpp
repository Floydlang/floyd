...
runtime_value_t get_keys__cppmap_carray(value_backend_t& backend, runtime_value_t dict_value, runtime_type_t dict_type){
	...
	auto result_vec = alloc_vector_carray(backend.heap, count, count, type_t::make_vector(backend.type_interner, type_t::make_string()));
...
runtime_value_t get_keys__cppmap_hamt(value_backend_t& backend, runtime_value_t dict_value, runtime_type_t dict_type){
	...
	auto result_vec = alloc_vector_hamt(backend.heap, count, count, type_t::make_vector(backend.type_interner, type_t::make_string()));
